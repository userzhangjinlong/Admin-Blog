<template>
    <div class="login-wrap">
        <div class="ms-login">
            <div class="ms-title">张金龙blog后台管理系统</div>
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="ms-content">
                <el-form-item prop="username">
                    <el-input v-model="ruleForm.username" placeholder="用户账户">
                ...
                <el-form-item prop="yzm" style="width: 48%;">
                    <el-input  placeholder="验证码" v-model="ruleForm.yzm" >
                        <el-button slot="prepend" icon="el-icon-lx-roundcheck"></el-button>
                    </el-input>
                </el-form-item>
                <div class="login-btn">
